      ...
      <div className='content'>
        <table>
          ...
          <tr>
             ...
             <td></td>
             <td className='description'> NO. O SHORES 3' - 4'6" (GREEN) </td>
           ...
           <tr>
             ...
             <td></td>
             <td className='description'> NO. O SHORES 4' - 6'6" (SILVER)</td>
           ...
           <tr>
             ...
             <td></td>
             <td className='description'> NO. O SHORES 3'9" - 6' (GREEN) </td>
